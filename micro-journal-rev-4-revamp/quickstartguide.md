# Micro Journal Rev.4 – User Guide
...
* **One USB A to C cable** – required to connect the device to a computer. Make sure that it is a data cable, not just a charging cable.
