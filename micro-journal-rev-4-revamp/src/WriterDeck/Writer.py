from WriterDeck.FileBuffer import FileBuffer
from WriterDeck.ScreenBuffer import ScreenBuffer
...
class Writer:
    ...
    def __init__(self):
        ...
        if not hasattr(self, "initialized"):
            ...
            self.screen_buffer = ScreenBuffer(cols=40, max_lines=100)
            self.saved = True
            self.locked = False
    ...
    def handle_key_event(self, key, pressed=True):
