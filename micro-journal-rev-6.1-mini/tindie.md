...
A playwright from New York once asked for a writing device he could carry around, use in cafés, and proudly show off. He wanted something compact, practical, and stylish.
...
DO NOT ASK FOR SWITCHES IN DIY KIT. SWITCHES AND KEYCAPS ARE NOT INCLUDED IN DIY KIT
...
* Dimension 25 x 8 x 20 cm, 1.2 kg

### Usage Video 

Please, watch the use case video in order to understand the features and most importantly, limitation of the device. 

* [Micro Journal Rev.6.1: Mini - Features and Use Cases](https://youtu.be/DYZrfpyJvLY)
