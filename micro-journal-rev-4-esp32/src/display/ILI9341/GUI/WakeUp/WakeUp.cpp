...
bool WakeUp_load_gif_sd(String filename)
{
    ...
    if (SD.exists(filename))
    {
        ...
        {
            _log("File size too big %d from SD\n", gif_image_size);
            return false;
        }
        ...
        if (gif_image == NULL)
        {
            _log("Failed to allocate memory\n");
            return false;
        }
        _log("File alloc success\n");
...
bool WakeUp_load_gif_spiffs(String filename)
{
    ...
    {
        _log("File size too big %d from SPIFFS\n", gif_image_size);
        return false;
    }
