...
Example:
  python generate_u8g2_korean_font.py NanumGothicCoding-Regular.ttf 24 \
      src/display/RLCD/fonts/u8g2_font_nanum_24_t_korean.c u8g2_font_nanum_24_t_korean
"""
...
def main():
    ...
    with open(out_path, "w", newline="\n") as f:
        f.write(
            ...
            f"  NanumGothicCoding (Copyright NAVER Corporation, SIL Open Font\n"
            f"  License 1.1) rasterized at {size}px.\n"
