...
** Note: LIPO battery is NOT included. EU delivery restrictions prevent batteries in the parcel. The device requires one 18650 battery to operate. Please source the battery separately. Also, SD card is not included.
...
Micro Journal Rev.5.1 perfect for capturing sudden bursts of inspiration or quickly jotting down important tasks or ideas. It's a device that can be kept on your bedside table, ready to record your dreams at a moment's notice. All you need to do is find the power switch before immortalizing your weirdest dream ever in writing.
...
* [Behind Story](https://github.com/unkyulee/micro-journal/blob/main/micro-journal-rev-5.1/story.md)
* [Micro Journal Rev.5.1 Features and Use Cases](https://youtu.be/4LoZSAb_AXQ)
* [Quick Start Guide](https://github.com/unkyulee/micro-journal/tree/main/micro-journal-rev-5-esp32-usbhost/quickstart/readme.md)
