...
#### **DIY Kit**:
  ...
  * Keyboard PCB - 68 keys
  * O-ring 18x13.2x2.4
  * Two Voltage 18650 Lithium Battery Shield 
  * 2x Micro USB cable - 2 pin USB male
  * 16mm SPST Snap in On/Off Round Switch
  * 1x Micro to type C USB cable for keyboard 
  * 2x EC11 15mm Half Handle Rotary Encoder
  * Micro SD card 32 GB
  * mini HDMI cable
  * OTG 3/4 port Micro USB Power Charging Hub
  * Various M3, M2 hex screws, and heat inserts

**DIY KIT SHALL BECOME AVAILABLE IN 2026** 
...
* [Micro Journal Rev.2.1 Colors](https://www.youtube.com/playlist?list=PLrUXYLEnAaNRd9ljLqhpGUvfFxRIZDCQe)
...
* [Design Files](https://github.com/unkyulee/micro-journal/tree/main/micro-journal-rev-2.1/STL)
* [Keyboard PCB](https://github.com/unkyulee/micro-journal/tree/main/micro-journal-rev-7-e-ink/PCB/SMD)
* [QMK-Vial Source Code](https://github.com/unkyulee/micro-journal/tree/main/micro-journal-rev-2.1/keyboard)



### Videos

* [Features and Use cases](https://youtu.be/-P8MK0iT04k)
